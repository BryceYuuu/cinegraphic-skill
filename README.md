...
> **Click to expand. English is on the left, Chinese on the right.**  
> **点击展开。左侧英文，右侧中文，中间分栏对照。**
...
<tr>
<td width="50%" valign="top">
<pre><code>Transform the provided reference image into a sophisticated mid-century modern editorial poster.
...
- unnecessary text
- modern advertising aesthetics</code></pre>
</td>
<td width="50%" valign="top">
<pre><code>将输入参考图片重新设计成一张高级的复古现代主义编辑海报。
...
<tr>
<td width="50%" valign="top">
<pre><code>Analyze the provided reference image only for its high-level visual structure.
...
It should look like an original collectible vintage editorial poster, not a recreation of an existing movie poster or artwork.</code></pre>
</td>
<td width="50%" valign="top">
<pre><code>首先只分析输入参考图片的高层视觉信息。
...
<tr>
<td width="50%" valign="top"><pre><code>generic AI art,
3D render,
plastic skin,
...
stock photo aesthetics</code></pre></td>
<td width="50%" valign="top"><pre><code>普通AI插画感，
3D渲染，
塑料皮肤，
摄影级皮肤纹理，
赛博朋克霓虹，
